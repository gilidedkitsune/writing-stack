...
These scaffolds carry structure plus any content-type-specific reminders. They do not define brand voice, tone of voice, or persuasion strategy: those come from `write-strike` and its sources (`tone-and-guidelines`, `bolter-tones`).
